 ...
 * @author NewUser
 */
public class Google_Obter_Links {
    
    Browser_Automato_Submenu_01 Browser_Automato_Submenu_01;
    String html;
    
    public Google_Obter_Links(Browser_Automato_Submenu_01 Browser_Automato_Submenu_012, String html2) {
    ...
    private void inicio( String linha ) {        
        /*new Thread() {   @Override public void run() {*/ try { Thread.sleep( 1 ); 
            ...
            if( linha.trim().equalsIgnoreCase( "<div class=\"g\">" ) ){                
                tag_1 = true;
                ...
                if( linha.trim().equalsIgnoreCase("</div>") ){  
