...
import browser_automato_menu_e_submenu.Browser_Automato_Menu_01;
 ...
 * @author NewUser
 */
public class Browser_Automato_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Browser_Automato_Menu_01( Home ).Barra_Menu );
        Home.adicionar_SubMenu(new Browser_Automato_Submenu_01( Home ) );
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new Browser_Automato_00_Main();
        applet.init();
